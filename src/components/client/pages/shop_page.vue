            ...
            <div class="card border-0 shadow-sm">
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-baseline">
                  ...
                  <del class="h6 font-weight-normal text-dark" v-if="item.origin_price">NT.{{item.origin_price}}元</del>
                  <div class="h5 text-dark" v-if="item.origin_price"><span class="text-info">特價</span> {{item.price}}元</div>
                </div>
              </div>
